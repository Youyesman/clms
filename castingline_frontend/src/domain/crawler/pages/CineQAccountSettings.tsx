...
export const CineQAccountSettings = () => {
    ...
    const load = async () => {
        setLoading(true);
        try {
            const res = await AxiosGet("crawler/cineq_accounts/");
    ...
    const addAccount = async () => {
        ...
        try {
            await AxiosPost("crawler/cineq_accounts", newDraft);
    ...
    const saveEdit = async (id: number) => {
        ...
        try {
            await AxiosPatch("crawler/cineq_accounts", editDraft, id);
    ...
    const toggleActive = async (a: IAccount) => {
        try {
            await AxiosPatch("crawler/cineq_accounts", { is_active: !a.is_active }, a.id);
            load();
        } catch {
    ...
    const removeAccount = (a: IAccount) => {
        showAlert(
            ...
            async () => {
                try {
                    await AxiosDelete("crawler/cineq_accounts", a.id);
    ...
    return (
        <Wrapper>
            <Intro>
                <p>
                    씨네큐 스코어 크롤에 사용할 배급사 로그인 계정을 관리합니다.
